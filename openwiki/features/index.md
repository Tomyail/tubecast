...
- [Feature Modules](overview.md) - TubeCast feature modules under /src/features/ — player, playlist, YouTube feed, jobs, discover, demo mode, remote config, share links, settings, audio export, app review, and the Kickstart Exchange banner — with responsibilities, key files, and pointers to deeper per-system pages.
